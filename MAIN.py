...
from HGraphormer import ViT,GCN
...
parser.add_argument('--PCA_band', type=int, default=70, help='pca_components')#ip70 sa 70 hu 100
...
for run in range(args.num_run):
    ...
    tr_net = ViT(
        band=band,
        num_token=args.patches*args.patches,
    ...
    for epoch in range(args.epoches):
        ...
        gcn_net.train()
        tr_net.train()
        train_acc, train_obj, tar_t, pre_t = train_epoch(tr_net, label_train_loader, criterion, optimizer,
                                                         optimizer2)
